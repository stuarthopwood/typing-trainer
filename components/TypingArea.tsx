...
export default memo(function TypingArea({ text, onComplete, onProgress, onKeyPress }: TypingAreaProps) {
  ...
  return (
    <div ref={containerRef} className="relative" tabIndex={0} role="application" aria-label="Typing area — type the displayed text. Press Escape to exit.">
      ...
      >
        <p
          className="text-3xl sm:text-4xl md:text-5xl leading-[1.8] tracking-wide whitespace-pre-wrap select-none text-center font-[family-name:var(--font-typing)] flex items-center justify-center"
